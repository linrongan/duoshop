...
class product extends wx
{
    ...
    function GetShowProduct()
    {
        ...
        $product = $this->GetDBSlave1()->queryrow("SELECT P.*,PD.product_text,PD.product_flash FROM ".TABLE_PRODUCT." AS P "
    ...
    {
        $shouchang = $this->GetDBSlave1()->queryrow("SELECT * FROM ".TABLE_PRODUCT_COLLE."  "
