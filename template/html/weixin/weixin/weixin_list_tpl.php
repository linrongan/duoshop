			...
			<div id='list' class="mui-indexed-list">
				...
				<div class="mui-indexed-list-inner">
					...
					<ul class="mui-table-view">
						...
						<li data-value="" data-tags="ALiKunSha" class="mui-table-view-cell mui-indexed-list-item">阿里昆莎机场</li>
						<li data-value="ANGQQG" data-tags="AnQingTianZhuShan" class="mui-table-view-cell mui-indexed-list-item">安庆天柱山机场</li>
