...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/template/source/weixin/css/sec.kill.css?777777">
 	<style>
		...
		.consultation>a{padding:5px 40px; text-align:center; border:1px solid #666; color:#333; display:inline-block; border-radius:3px; vertical-align:middle;}
...
<div class="problem" >
	<div class="weui-cells">
    	<div class="weui-cell weui-cell_access problem_en yes">
        	<div class="weui-cell__bd">
            	<p class="rf14" style="color:#09F">问：常见问题一</p>
            </div>
            <div class="weui-cell__ft down"></div>
        </div>
        <div class="weui-cell problem_view">
        	<div class="weui-cell__bd">
        		<p class="rf13 cl_b3">答：解决方法</p>
            </div>
        </div>
    </div>
    <div class="weui-cells">
    	<div class="weui-cell weui-cell_access problem_en yes">
        	<div class="weui-cell__bd">
            	<p class="rf14" style="color:#09F">问：常见问题二</p>
            </div>
            <div class="weui-cell__ft down"></div>
        </div>
        <div class="weui-cell problem_view">
...
<p class="mt10 rf13 cl_b9" style="padding:0 3%;">温馨提示：如果没有您想要的问题，可进行人工咨询</p>
