...
<head>
    ...
    <link rel="stylesheet" href="/template/source/weixin/css/mui.picker.css"/>
...
<div class="mui-content">
    ...
    <div class="web-address-content">
        ...
        <div style="padding:0 10%;" class="tc mtr30">
            <a href="javascript:;" id="edit-address" data-loading-icon="mui-spinner mui-spinner-custom" class="mui-btn mui-btn-danger fr16" style="padding:8px 60px;width: 100%; line-height: 1.7 ">修改地址</a>
        </div>
...
<script src="/template/source/weixin/js/mui.picker.js"></script>
<script src="/template/source/weixin/js/mui.poppicker.js"></script>
<script src="/template/source/weixin/js/city.data.js" type="text/javascript" charset="utf-8"></script>
<script src="/template/source/weixin/js/city.data-3.js" type="text/javascript" charset="utf-8"></script>
<script>
    (function($, doc) {
        $.init();
        $.ready(function() {
