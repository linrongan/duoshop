        ...
        <div class="web-cells">
            <div class="web-cell">
                ...
                <div class="web-cell__bd ">
                    <input type="text" id="shop_name" class="web-input fr14 tr" placeholder="请输入收货人">
                </div>
            ...
            <div class="web-cell">
                ...
                <div class="web-cell__bd ">
                    <input type="number" id="shop_phone" class="web-input fr14 tr" maxlength="11" placeholder="请输入手机号">
                </div>
                <div class="web-cell__ft"></div>
            </div>
            <div class="web-cell web-cell_access">
                ...
                <div class="web-cell__bd ">
                    <input type="text" class="web-input fr14 tr" id="address_location" readonly placeholder="请选择所在地址">
                </div>
                <div class="web-cell__ft"></div>
            </div>
            ...
            <div class="web-cell">
                <div class="web-cell__bd ">
                    <textarea class="web-textarea fr14" rows="3" id="address_details" placeholder="请输入详情地址"></textarea>
                </div>
            </div>
        </div>
        <div class="web-cells">
            <div class="web-cell weui-cell_switch">
                ...
                <div class="weui-cell__ft">
                    <input class="weui-switch" id="default_select" value="1" type="checkbox" checked>
                </div>
            </div>
        </div>

        <div style="padding:0 10%;" class="tc mtr30">
            <a href="javascript:;" id="new-address" data-loading-icon="mui-spinner mui-spinner-custom" class="mui-btn mui-btn-danger fr16 " style="padding:8px 60px;width: 100%; line-height: 1.7 ">确认地址</a>
        </div>
    </div>
...
<script>
    ...
    $("#new-address").click(function ()
    {
        ...
        $.ajax({
            type:"post",
            url:"<?php echo _URL_; ?>&_action=ActionAddAddress",
            data:data,
            dataType:"json",
