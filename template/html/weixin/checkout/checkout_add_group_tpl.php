...
<div id="content" style="padding:0 0 .9rem 0">
    <form id="form" action="/?mod=weixin&v_mod=checkout&_index=_add_group&id=<?php echo $_GET['id']; ?>&_action=ActionAddGroupBuy" method="post">
        ...
        <div class="withdraw-ft">
            <div class="support_bar">
                ...
                <div class="support_bar_btn sz16r">
                    <a id="submit" href="javascript:;">提交订单</a>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function(){
        $(".quantity-wrapper").on('click','.plus',function(event){
            ...
            location.href = '/?mod=weixin&v_mod=checkout&_index=_add_group&' +
                'id=<?php echo $_GET['id'] ?>&quantity='+value;
    ...
    $("#submit").click(function ()
    {
        ...
        $(this).after('<input type="hidden" name="action" value="1">');
