...
if($data['pay_status'])
{
    ...
    <div class="weui-msg">
        ...
        <div class="weui-msg__text-area">
            <h2 class="weui-msg__title"><?php echo $data['group_buy_type']?'开团成功':'参与团购成功'; ?></h2>
            ...
            <div class="weui-form-preview">
                <div class="weui-form-preview__bd">
                    <div class="weui-form-preview__item">
                        ...
                        <span class="weui-form-preview__value">￥<?php echo $data['group_total']; ?></span>
                    </div>
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">运费</label>
                        <span class="weui-form-preview__value">￥<?php echo $data['ship_fee']; ?></span>
                    </div>
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">支付方式</label>
                        <span class="weui-form-preview__value"><?php echo $data['pay_method']=='user_money'?'余额支付':'微信支付'; ?></span>
                    </div>
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">付款时间</label>
                        <span class="weui-form-preview__value"><?php echo $data['pay_date']; ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="" style="padding:.4rem 10%;">
        <a class="weui-btn weui-btn_default" href="/?mod=weixin&v_mod=group&_index=_buy&group_id=<?php echo $data['group_id']; ?>">返回</a>
    </div>
    <?php
    }else
    {
    ...
    <div class="" style="padding:.4rem 10%;">
        <a class="weui-btn weui-btn_default" href="/?mod=weixin&v_mod=checkout&_index=_group_pay_result&orderid=<?php echo $_GET['orderid']; ?>">刷新页面</a>
    </div>
    <?php
}
?>
