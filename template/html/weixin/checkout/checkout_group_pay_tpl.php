...
$data = $obj->GetGroupBuy();
include RPC_DIR.'/module/common/wechat_pay.php';
$wechat_pay = new wechat_pay();
$array = array(
    'out_trade_no'=>$data['orderid'],
    'total_fee'=>$data['group_total'],
    'notify_url'=>WEBURL.'/pay/weixin/pay_group_buy.php'
);
...
<head>
    ...
    <title><?php echo $data['group_buy_type']?'创建团购支付':'加入团购支付'; ?></title>
    ...
    <script type="text/javascript">
        var link = '?mod=weixin&v_mod=checkout&_index=_group_pay_result&orderid=<?php echo $_GET['orderid']; ?>';
        function jsApiCall()
        {
