...
$data = $obj->GetDiscountDetail();
if(empty($data))
{
    redirect(NOFOUND.'&msg=折扣卷不存在');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<header>
    <div id="m_common_header"><header class="duo-header">
            <div class="duo-header-bar">
                ...
                <div class="duo-header-title">领取折扣金额</div>
                ...
                <div class="coupon-box coupon-dong">
                    <div class="coupon-value">
                        <div class="value-content">
                            <p class="money"><em>¥</em><strong><?php echo $data['share_money'];?></strong></p>
                            <p class="rule"></p>
                        </div>
                    </div>
                ...
                <div class="new-pay-pw">
                    <div class="receive-btn">
                        ...
                        <?php
                            ...
                            {
                                $coupon = $obj->CheckHasDiscount($data['store_id']);
                                if(!$coupon)
                                {
                                    ?>
                            ...
                            {
                                ?>
                                <a  href="javascript:void(0);" class="btn-bot">已领完</a>
                                <?php
                            }
                        ?>
                    </div>
...
<script>
    $(function(){
        ...
        $("#determine").on("click",function(){
            var share_key = '<?php echo $data['share_key'];?>' ;
            $.ajax({
                cache:false,
                type:"POST",
                url:"/?mod=weixin&v_mod=coupon&_action=ActionApplyDiscount",
                ...
                success:function(result) {
                    ...
                    if (result.code==0)
                    {
                        $('.receive-btn').html('<a  href="javascript:void(0);" class="btn-bot">已领取</a>');
