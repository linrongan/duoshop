            	...
            	<div class="mjd-coupon-con">
                    <div class="coupon-box coupon-dong">
                        ...
                        <div class="coupon-info" style="word-wrap: break-word;">
                            ...
                            <p class="use-time"><?php echo date("Y.m.d",strtotime($data['start_time']));?> 至
                                <?php echo date("Y.m.d",strtotime($data['end_time']));?></p>
                        </div>
                    </div>
                </div>
...
$(function(){
    ...
    $("#determine").on("click",function(){
        ...
        $.ajax({
            cache:false,
            type:"POST",
            url:"/?mod=weixin&v_mod=coupon&_action=ActionReceiveCoupon",
            data:{'id':id},
            dataType:"json",
