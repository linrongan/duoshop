...
<div class="mui-content">
    ...
    <div class="web-cart-error tc" style="display: <?php  echo $data?'none':'block'; ?>;">
        ...
        <div class="mtr30 error-btn"><a href="/?mod=weidian&v_mod=address&_index=_add&v_shop=<?php echo $_GET['v_shop']; ?>&callback=<?php echo urlencode(_URL_); ?>">添加地址</a></div>
    </div>
                    ...
                    <div class="web-cells">
                        ...
                        <div class="web-cell">
                            ...
                            <div class="web-cell__bd tr">
                                <a href="/?mod=weidian&v_mod=address&_index=_edit&id=<?php echo $item['id']; ?>&v_shop=<?php echo $_GET['v_shop']; ?>&callback=<?php echo urlencode(_URL_); ?>" class="ml20 fr14 cl_b9"><i class="fa fa-edit mr5"></i>编辑</a>
    ...
    <div class="web-cart-error tc" id="more-add" style="display:<?php echo !$data || count($data)==6?'none':'block'; ?>;">
        <p class="fr16 cl_b3">亲，最多可设置6个收货地址</p>
        <div class="mtr30 error-btn"><a href="/?mod=weidian&v_mod=address&_index=_add&v_shop=<?php echo $_GET['v_shop']; ?>&callback=<?php echo urlencode(_URL_); ?>">添加地址</a></div>
    </div>
</div>
