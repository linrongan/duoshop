...
<div>
    ...
    <div class="web-footer bgF">
        ...
        <a href="<?php echo WEBURL.'/?mod=weidian&v_mod=category&_index=_product&v_shop='.$v_shop.''; ?>" class="tc f12">
            <i class="web-footer-icon"></i>
            <span>分类</span>
        </a>
        <a href="<?php echo WEBURL.'/?mod=weixin&v_mod=cart&v_shop='.$v_shop.''; ?>" class="tc f12">
            <i class="web-footer-icon"></i>
            <span>购物车</span>
        </a>
