...
<div class="mui-content">
    ...
    <div class="web-address-content">
        ...
        <div style="padding:0 10%;" class="tc mtr30">
            <a href="javascript:;" data-loading-icon="mui-spinner mui-spinner-custom" class="mui-btn mui-btn-danger fr16 " id="sumbit" style="padding:8px 60px;width: 100%; line-height: 1.7 ">确认地址</a>
        </div>
    </div>
