        ...
        <?php
            if(empty($data))
            {
                ...
                <div class="web-cart-error tc" style="display: block;">
                    ...
                    <p class="fr16 cl_b3 mt10">暂无绑定银行卡</p>
                    <div class="mtr30 error-btn"><a href="<?php echo WEBURL.'/?mod=weidian&v_mod=wallet&_index=_bank_info&v_shop='.$v_shop.''; ?>">＋ 添加银行卡</a></div>
                </div>
                <?php
            }
        ?>
        ...
        <div class="web-wallet-body">
                        ...
                        if($data)
                        {
                            foreach($data as $item)
                            {
                                ...
                                <li class="web-bank-item"
                                    onclick="location.href='/?mod=weidian&v_mod=wallet&_index=_bank_detail&id=<?php echo $item['id']; ?>&v_shop=<?php echo $v_shop; ?>'">
                                    <div class="web-bank-mess">
                                        <h1 class="fr16"><?php echo $item['bank_card_name']; ?></h1>
                                            <p class="fr14">持卡人：<?php echo $item['bank_card_uname']; ?></p>
            ...
            <?php
                if(count($data)<3)
                {
                    ?>
                    <div class="web-cells">
                        <a href="<?php echo WEBURL.'/?mod=weidian&v_mod=wallet&_index=_bank_info&v_shop='.$v_shop.''; ?>" class="web-cell web-cell_access">
