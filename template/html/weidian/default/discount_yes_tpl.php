...
<head>
    ...
    <style>
        ...
        .yes-discount-icon{width:50px; height: 50px; background:url(/template/source/default/images/yes_discount_i.png) no-repeat; background-size:100% 100%; position:absolute;     right: 3%;  top: 50%;  margin-top: -25px;}
...
<div class="mui-content">
    <div class="web-opder-nav">
        <a href="<?php echo WEBURL.'/?mod=weidian&v_mod=discount&_index=_no&v_shop='.$v_shop.''; ?>" class=" fr14 cl_b3 tc">未使用</a>
        <a href="<?php echo WEBURL.'/?mod=weidian&v_mod=discount&_index=_yes&v_shop='.$v_shop.''; ?>" class="web-order-active fr14 cl_b3 tc">已过期</a>
    </div>
        ...
        <div class="web_discount_warp">
            <div class="web_discount_item">
                <ul>
                    <li>
                        <a href="javascript:;">
                            <div class="web_discount_price white fr18 ">
                                ￥<span>20</span>
                            </div>
                            <div class="web-discount_mess">
                                <h1 class="cl_b3">满<span class="red">299</span>使用</h1>
                                <p class="cl_b9 mt5 f16">使用时间：8.13-8.25</p>
                            </div>
                            <i class="yes-discount-icon"></i>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:;">
                            ...
                            <div class="web-discount_mess">
                                <h1 class="cl_b3">满<span class="red">499</span>使用</h1>
                                <p class="cl_b9 mt5 f16">使用时间：8.13-8.25</p>
                            </div>
                            <i class="yes-discount-icon"></i>
                        </a>
                    ...
                    <li>
                        <a href="javascript:;">
                            ...
                            <div class="web-discount_mess">
                                <h1 class="cl_b3">满<span class="red">899</span>使用</h1>
                                <p class="cl_b9 mt5 f16">使用时间：8.13-8.25</p>
                            </div>
                            <i class="yes-discount-icon"></i>
                        </a>
