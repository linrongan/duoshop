...
<div class="page-container">
    <form action="?mod=admin&v_mod=admin_sekill&_index=_new&id=<?php echo $_GET['id']; ?>&_action=ActionNewSekillProduct" method="post" class="form form-horizontal" id="check_form">

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>秒杀库存：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder=""  name="seckill_stock">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="0" placeholder=""  name="seckill_buy_stock">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="seckill_one_count" placeholder="" value="" class="input-text">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text"  disabled value="<?php echo $data['product_price']; ?>" class="input-text" style="width:30%">
                元</div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="seckill_price"  placeholder="" value="" class="input-text" style="width:90%">
                元</div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="seckill_sort"  placeholder="" value="0" class="input-text" style="width:90%">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" onfocus="WdatePicker()" id="datemax" name="start_day" value="" class="input-text Wdate" style="width:120px;">
            </div>
        </div>
                    ...
                    <?php
                        if(!empty($quantum)){
                            foreach($quantum as $item){
                                ?>
                                <option value="<?php echo $item['quantum_id'];?>"><?php echo $item['quantum'];?>【<?php echo $item['start_time'].'-'.$item['end_time'];?>】</option>
                                <?php
                            }
                        }
                    ?>
