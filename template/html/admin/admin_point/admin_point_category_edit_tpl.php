...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionEditCategory';?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 图片(90*90)：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <div id="fields_image_upload"></div>
                <input type="hidden" name="fields_image" value="<?php echo $data['category_img'];?>" id="fields_image">
                <div id="fields_image_show"><img width="100" src="<?php echo $data['category_img'];?>" alt=""/></div>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['category_name'];?>" placeholder="" name="category_name">
            </div>
        </div>
