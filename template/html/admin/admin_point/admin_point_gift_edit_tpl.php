...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionEditGift';?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 礼品名字：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['gift_name']; ?>" placeholder="" name="gift_name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="picture_path_upload">
                        <input type="hidden" value="<?php echo $data['source_img']; ?>" name="source_img" id="img">
                    </div>
                    <div id="picture_path_pic">
                        <img  src="<?php echo $data['source_img']; ?>" width="100" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    ...
                    <input type="hidden" value="<?php echo $data['gift_img']; ?>" name="gift_img" id="gift_img">
                    <div id="show_cover2">
                        <img  src="<?php echo $data['gift_img']; ?>" width="100" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <select class="select" required name="category_id" id="category_id">
                        ...
                        if($category)
                        {
                            foreach($category as $item){
                                ?>
                                <option <?php if ($item['category_id']==$data['category_id']){ echo 'selected';}?> value="<?php echo $item['category_id'];?>"><?php echo $item['category_name'];?></option>
                            <?php
                            }
                        }
                        ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['gift_point']; ?>" placeholder="" name="gift_point">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['qty']; ?>" placeholder="" name="qty">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['unit']; ?>" placeholder="" name="unit">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['ry_order']; ?>" placeholder="" name="ry_order">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 图文：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="content" id="content" rows="10"><?php echo $data['content']; ?></textarea>
            </div>
        </div>
