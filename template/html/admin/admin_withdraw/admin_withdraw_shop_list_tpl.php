...
<div class="page-container">
    <form action="" method="post" class="mb-20">
        <div> 日期范围：
            ...
            <input value="" type="text" placeholder="请输入店铺" id="store_name" name="store_name" class="input-text ac_input" style="width:200px">
            ...
            if($data['data'])
            {
                foreach($data['data'] as $item)
                {
                    ...
                    <tr class="text-c">
                        ...
                        <td>
                            <a style="text-decoration:none" class="ml-5" onclick="withdrawals_shop_edit('商家提现','/?mod=admin&v_mod=admin_withdraw&_index=_shop_details',<?php echo $item['id']; ?>)" href="javascript:;" title="编辑余额"><i class="Hui-iconfont"></i></a>
                        </td>
                    </tr>
                    <?php
                }
...
<script type="text/javascript">
    ...
    function withdrawals_shop_edit(title,url,id){
