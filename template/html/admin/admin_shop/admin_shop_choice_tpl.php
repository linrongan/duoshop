...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionChangeShopChoice&id='.$_GET['id']; ?>" method="post" class="form form-horizontal" id="check_form">


        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">排序：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder=""  name="show_sort">
            </div>
        </div>
