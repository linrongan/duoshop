...
<article class="page-container">
    <form action="?mod=admin&_index=_account_new&_action=ActionNewAdmin" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="adminAccount" name="adminAccount">
            </div>
        </div>
        <div class="row cl">
