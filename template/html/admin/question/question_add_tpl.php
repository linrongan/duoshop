...
<article class="page-container">
    <form action="<?php echo _URL_; ?>&_action=ActionAddQuestion"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="qusetion" required cols="" rows="" class="textarea" placeholder=""
                          onkeyup="$.Huitextarealength(this,150)"></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="answer" cols="" required rows="" class="textarea" placeholder=""
                          onkeyup="$.Huitextarealength(this,255)"></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="0" maxlength="11" placeholder="" name="ry_order">
            </div>
        </div>
