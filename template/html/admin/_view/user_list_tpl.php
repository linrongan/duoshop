                ...
                if($data['data'])
                {
                    foreach($data['data'] as $item)
                    {
                        ...
                        <tr class="text-c">
                            ...
                            <td><img src="<?php echo $item['headimgurl']; ?>" width="50" alt=""></td>
                            <td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')"><?php echo $item['nickname']; ?></u></td>
