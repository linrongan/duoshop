...
<div class="page-container">
    ...
    <div class="mt-20">
        ...
        $page=new page_nav(array(
            ...
            "extUrl"=>"",
            "canshu"=>'&mod='.$_GET['mod'].'&v_mod='.$_GET['v_mod'].'&_index='.$_GET['_index'].$data['param'].'&id='.$_GET['id']
        ));
        echo $page->page_nav();
        ?>
    </div>
...
function select_del()
{
    ...
    layer.confirm('确认要批量添加吗？',function(index)
    {
        ...
        $.ajax({
            type: 'POST',
            url: '?mod=admin&v_mod=admin_active&_action=ActionAddActiveProduct',
            data:{id:select_id,cid:cid},
            dataType: 'json',
