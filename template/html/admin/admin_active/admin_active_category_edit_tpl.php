...
$data = $obj->getActiveCategoryDetail();
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionEditActiveCategory';?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 分类名字：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['c_name'];?>" placeholder="" name="c_name">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="picture_path_upload">
                        <input type="hidden" value="<?php echo $data['c_img'];?>" name="c_img" id="img">
                    </div>
                    <div id="picture_path_pic">
                        <img width="150" src="<?php echo $data['c_img'];?>" alt=""/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['c_sort'];?>" placeholder="" name="c_sort">
            </div>
        </div>
