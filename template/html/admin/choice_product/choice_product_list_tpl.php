...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
            <a href="javascript:;" onclick="location.href='?mod=admin&v_mod=admin_product&_index=_list'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加精选产品</a>
            ...
            <?php if (!empty($data['data'])){
                foreach($data['data'] as $item){
                    ...
                    <tr class="text-c">
                        ...
                        <td class="center">
                            <?php echo $item['show_sort']; ?>
                        </td>

                        <td class="center">
                            <?php echo $item['show_status']==0?'精选':'已取消'; ?>
                        </td>

                        <td class="center">
                            <a style="text-decoration:none" class="ml-5"
                               onClick="product_edit('编辑精选【<?php echo $item['product_name']; ?>】','?mod=admin&v_mod=choice_product&_index=_edit',<?php echo $item['product_id']; ?>)"
                               href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i>
                            </a>
                            <a style="text-decoration:none" onClick="product_cancel_tj(this,<?php echo $item['product_id']; ?>)" href="javascript:;" title="取消精选"><i class="Hui-iconfont">&#xe60b;</i></a>
                        </td>
                    </tr>
                <?php }
            } ?>
...
<script type="text/javascript">
    ...
    function product_cancel_tj(obj,id){
        layer.confirm('确认取消精品推荐吗？',function(index)
        {
            $.ajax({
                type:"post",
