...
$url = '?mod=admin&v_mod=admin_bargain&_index=_product_add&id=';
$title = '添加到砍价';
if(isset($_GET['type']) && $_GET['type']=='agent')
{
    $url = '?mod=admin&v_mod=admin_agent&_index=_product_add&id=';
    $title = '添加到一件代发';
}
//var_dump($data);exit;
?>
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            if($data['data'])
            {
                ...
                {
                    ?>
                    <tr class="text-c va-m" onclick="product_add('<?php echo $title;?>','<?php echo $url.$item['product_id'];?>')">
