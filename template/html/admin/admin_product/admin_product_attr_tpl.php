...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20 mb-20"> <span class="l">
            <a href="javascript:;" onclick="attr_add('添加属性','?mod=admin&v_mod=admin_product&_index=_attr_new&product=<?php echo $_GET['id'];?>','','450')" class="btn btn-primary radius">
...
<script type="text/javascript">
    ...
    function attr_del(obj,pid,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '?mod=admin&v_mod=admin_product&_index=_attr&_action=ActionDelProductAttr&product='+pid+'&id='+id,
                ...
                success: function(res)
                {
                    ...
                    window.location="?mod=admin&v_mod=admin_product&_index=_attr&id="+pid;
                },
                error:function(res) {
                    console.log(res.msg);
                }
