...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionAddBanner'; ?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="0" placeholder="" id="picture_sort" name="picture_sort">
            </div>
        </div>
        <div class="row cl">
