...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionEditBanner'; ?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>图片标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['picture_title']; ?>" placeholder="" id="picture_title" name="picture_title">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">图片链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['picture_url']; ?>" placeholder="" id="picture_url" name="picture_url">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">排序值：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['picture_sort']; ?>" placeholder="" id="picture_sort" name="picture_sort">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="picture_path_upload">
                        <input type="hidden" value="<?php echo $data['picture_path']; ?>" name="picture_path" id="picture_path">
                    </div>
                    <div id="picture_path_pic">
                        <?php
                            ...
                            {
                                ?>
                                <img src="<?php echo $data['picture_path']; ?>" width="140" height="140" class="thumbnail"/>
                                <?php
                            }
                        ?>
                    </div>
