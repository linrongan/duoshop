...
<article class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionAddNotice';?>" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" maxlength="50" name="title">
            </div>
        </div>
        <div class="row cl">
                ...
                <select class="select select-box" required name="alert_role_id" size="1">
                    ...
                    <?php
                        if(!empty($role))
                        {
                            ...
                            {
                                ?>
                                <option value="<?php echo $item['alert_role_id'];?>"><?php echo $item['name'];?></option>
                                <?php
                            }
                        }
                    ?>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" name="img" value=""  id="news_img">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="abstract"  maxlength="300"  rows="10" class="textarea radius"></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="alert_text" rows="10" class="textarea radius"></textarea>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">外链：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="alert_link" name="alert_link">
            </div>
        </div>
        <div class="row cl">
