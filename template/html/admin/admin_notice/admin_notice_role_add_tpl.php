...
<article class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionAddNoticeRole';?>" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" maxlength="50" name="name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" name="icon" value=""  id="news_img">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" value="0" name="ry_sort" class="input-text"/>
            </div>
        </div>
