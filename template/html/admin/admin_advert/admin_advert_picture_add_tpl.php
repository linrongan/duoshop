...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionAddPicture';?>" class="form form-horizontal" method="post" id="check-form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 广告标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" name="picture_title">
            </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 投放区域：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span> 投放时长（时）：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="" placeholder="" name="advert_day">
                （小时）
            </div>
        </div>
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select id="status" name="status" class="select valid" aria-required="true">
                        ...
                        <option disabled value="0">审核中</option>
                        <option disabled value="1">有效</option>
                        <option value="2">已过期(默认只能选择过期)</option>
                    </select>
                </span>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="page_url" name="picture_link">
            </div>
        </div>
