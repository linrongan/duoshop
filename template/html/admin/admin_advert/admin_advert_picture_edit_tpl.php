...
<div class="page-container">
    <form action="<?php echo _URL_.'&_action=ActionEditPicture';?>" class="form form-horizontal" method="post" id="check-form">
        ...
        <div class="row cl">
            ...
            <span class="c-red">*</span> 投放区域：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select name="picture_type" class="select valid" aria-required="true">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    ...
                    <div id="picture_path_pic" style="margin-top: 10px">
        ...
        <div class="formControls col-xs-8 col-sm-9">
        <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd H',minDate:'%y-%M-%d %H:%m:%s'})" id="datemin" name="start_time"
               value="<?php if($data['start_time'] && strtotime($data['start_time'])>0){echo $data['start_time'];} ?>" class="input-text Wdate" style="width:120px;">
        -
        <input type="text" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd H',minDate:'#F{$dp.$D(\'datemin\')}' })"
               id="datemax" name="expire_time" value="<?php if($data['expire_time'] && strtotime($data['expire_time'])>0){echo $data['expire_time'];} ?>" class="input-text Wdate" style="width:120px;">
        </div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">
            <span class="c-red">*</span> 投放状态：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box">
                    <select id="status" name="status" class="select valid" aria-required="true">
                        ...
                        <option value="2" <?php if ($data['status']==2){ echo 'selected';} ?> >已过期</option>
                    </select>
                </span>
            </div>
        </div>
