...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
    <span class="c-gray en">&gt;</span> 砍价商品 <span class="c-gray en">&gt;</span> 代发商品列表
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
            <a href="javascript:;" onclick="product_add('添加代发商品','?mod=admin&v_mod=admin_bargain&_index=_product_list&type=agent')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加代发产品</a>
            ...
            <?php if (!empty($data['data'])){
                foreach($data['data'] as $item){
                    ...
                    <tr class="text-c">
                        ...
                        <td class="center">
                            <?php echo $item['agent_price']; ?>
                        </td>
                        <td class="center">
                            <?php echo $item['agent_sort']; ?>
                        </td>
                        <td class="center">
                            <a style="text-decoration:none" class="ml-5"
                               onClick="product_edit('编辑代发【<?php echo $item['product_name']; ?>】','?mod=admin&v_mod=admin_agent&_index=_product_edit',<?php echo $item['id']; ?>)"
...
<script type="text/javascript">
    ...
    function product_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                type: 'POST',
                url: '?mod=admin&v_mod=admin_agent&_action=ActionDelAgentProduct',
                data:{'id':id},
                dataType: 'json',
