        ...
        <div> 日期范围：
            ...
            <span class="select-box" style="width:120px">
                <select class="select" name="balance_type">
                    ...
                    <option value="0"  <?php echo isset($_REQUEST['balance_type']) && $_REQUEST['balance_type']=='0'?'selected':''; ?>>支出</option>
                    <option value="1" <?php echo isset($_REQUEST['balance_type']) && $_REQUEST['balance_type']=='1'?'selected':''; ?>>收益</option>
                </select>
            </span>
        ...
        <?php if (!empty($data['data'])){
            foreach($data['data'] as $item){
                ...
                <tr class="text-c">
                    ...
                    <td><?php echo $item['admin_balance_type']==0?'支出':'收益';?></td>
