...
$select_attr = $obj->GetProductAttrList($_GET['id']);
if($select_attr)
{
...
<article class="page-container">
    <form action="?mod=admin&v_mod=product&_index=_attr_new&_action=ActionNewProductAttr&id=<?php echo $_GET['id']; ?>" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>属性：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <select class="select select-box" size="1" name="attr_temp_id">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-3">
                <input placeholder="请填写价格" id="attr_change_price" name="attr_change_price" type="number" class="input-text" value="<?php echo $product['product_price']; ?>">
                元
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input id="product_stock" name="product_stock" digits="true" type="number" class="input-text" value="0">
            </div>
        </div>
