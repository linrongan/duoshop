...
<div class="page-container">
    <form action="?mod=admin&v_mod=product&_index=_edit&id=<?php echo $_GET['id']; ?>&_action=ActionEditProduct" method="post" class="form form-horizontal" id="check_form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>产品名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['product_name']; ?>" placeholder="" name="product_name" id="product_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">产品描述：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['product_desc']; ?>" placeholder="" id="product_desc" name="product_desc">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo $data['product_sort']; ?>" placeholder=""  name="product_sort" id="product_sort">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="product_fake_price" id="product_fake_price"  placeholder="" value="<?php echo $data['product_fake_price']; ?>" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">销售价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="product_price" id="product_price"  placeholder="" value="<?php echo $data['product_price']; ?>" class="input-text" style="width:90%">
                元</div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" name="product_stock" id="product_stock" placeholder="请输入商品库存" value="<?php echo $data['product_stock']; ?>" class="input-text" style="width:90%"></div>
        </div>

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品销量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="product_sold" id="product_sold" placeholder="请输入展示的商品销量" value="<?php echo $data['product_sold']; ?>" class="input-text" style="width:90%"></div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="ship_fee" id="ship_fee" placeholder="请输入邮费" value="<?php echo $data['ship_fee']; ?>" class="input-text" style="width:90%">
                元</div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="product_param" id="product_param" cols="" rows="" style="height: 200px" class="textarea"><?php echo $data['product_param']; ?></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="product_text" id="product_text" cols="" rows="" style="height: 500px" class="textarea">
...
<script type="text/javascript">
    ...
    {
        var index = layer.confirm('确认要移除此图片吗？',function(index)
        {
