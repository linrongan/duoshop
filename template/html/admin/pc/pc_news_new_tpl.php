...
<article class="page-container">
    <form action="?mod=admin&v_mod=pc&_index=_news_new&_action=ActionNewNews" method="post" class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="hidden" name="news_img" value=""  id="news_img">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="news_desc"  maxlength="300"  style="width:500px;height: 200px;"></textarea>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="news_content" style="width:500px;height: 200px;"></textarea>
            </div>
        </div>
