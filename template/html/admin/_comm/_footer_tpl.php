...
<script type="text/javascript" src="/template/source/admin/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/template/source/admin/static/h-ui/js/H-ui.min.js"></script>
<script type="text/javascript" src="/template/source/admin/static/h-ui.admin/js/H-ui.admin.js"></script>
<script>
