...
if(!empty($data))
{
    ...
    {
        ?>
        <h1 class="tc apply-shop-title"><span class="f16">修改我的申请</span></h1>
        <div class="weui-cells" style="margin-top:0;">
            ...
            <div class="weui-cell">
                ...
                <div class="weui-cell__bd">
                    <input class="weui-input  f14" maxlength="11" id="email" value="<?php echo $data['email']; ?>" type="email"  placeholder="请输入您的常用邮箱地址">
                </div>
            </div>
...
<script>
    function apply(action)
    {
        ...
        $.ajax({
            type:'post',
            url:'/?mod=apply&_index=_shop&_action=ActionShopEditApply',
            data:{
                name:name,
                phone:phone,
                address:address,
